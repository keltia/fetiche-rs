...
A simple JSON-to-CSV file converter utility using Polars, part of the **fetiche** ecosystem.

## Description

This tool converts JSON Lines (JSONL) formatted files to CSV while preserving the column ordering. It uses
